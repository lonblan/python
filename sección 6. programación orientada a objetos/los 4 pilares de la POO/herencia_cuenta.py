...
print(ahorro)                 # Viene del padre (__str__).
ahorro.depositar(500)         # Método heredado del padre.
ahorro.generar_intereses()    # Método propio de la hija.
ahorro.retirar(200)           # Método heredado del padre (sin cambios).
print(ahorro)
